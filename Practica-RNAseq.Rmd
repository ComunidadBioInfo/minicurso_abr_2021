...
- [Descargar los datos que ocuparemos en está práctica]()
...
Analizar archivos curdos de RNAseq requiere poder de computo, si quieres hacer 
el análisis completo desde cero, necesitas una computadora con al menos RAM 8 GB
...
que una laptop. Por lo que se verán los comando para hacer el alineamiento en 
...
Seguir los pasos de la página de [Salmon]()
</div>
...
info <- dplyr::rename(info,names = Unique_id) # Renombrar la columna 
info
```
