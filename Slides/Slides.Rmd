...
# 2: Aplicaciones más comúnes del RNA-seq
---
## Aplicaciones
...
.font50[[Living in an adaptive world: Genomic dissection of the genus Homo and its immune response](https://rupress.org/jem/article/214/4/877/42247/Living-in-an-adaptive-world-Genomic-dissection-of)]
---
...
![fusion](./Images/Fusions.jpeg)
.font50[[Frequent CTLA4-CD28 gene fusion in diverse types of T-cell lymphoma](https://www.haematologica.org/article/view/7742)]
---
...
# 3: Consideraciones para el diseño experimental
---
...
[Martínez, Javier María Rodríguez. "Secuenciación de genomas." Arbor 177.698 (2004): 285-310.](http://www.encuentros.uma.es/encuentros138_9/secuenciacion.pdf)
]
---
...
```{r, out.width = "900px",fig.align='center'}
knitr::include_graphics("./Images/batch.jpeg")
```
...
knitr::include_graphics("./Images/balanced.jpeg")
```
...
# 5: Flujo de trabajo para el análisis de RNA-seq
---
...
# 6: Organización de un proyecto bioinformático

---

## Crisis de reproducibilidad en la ciencia

Para que dos o más personas realicen el mismo experimento bajo condiciones experimentales similares y obtengan resultados similares se requiere:
...
**Crisis de reproducibilidad** en la ciencia -> Perseguir explicaciones incorrectas -> Diseñar tratamientos incorrectos para ciertas enfermedades
...
coldata <- coldata %>% rename(names = unique_id)
coldata
...
# 10: Objeto Summarized Experiment
---
